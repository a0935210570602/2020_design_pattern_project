var World_map = function()
{
    ...
    this.init = function()
    {
        ...
        this.observer.registerObserver(this.character_description);
        this.observer.registerObserver(this.creation_blood_status);
        this.observer.getMessage(this.player1);
